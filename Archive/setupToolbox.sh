...
'spiderfoot: "wget http://sourceforge.net/projects/spiderfoot/files/spiderfoot-2.0.5-src.tar.gz/download"'
'The Harvester: "wget https://theharvester.googlecode.com/files/theHarvester-2.2a.tar.gz"'
);

declare -a pythonInstall=(
